...
from diffusion_hopping.analysis.evaluate.util import _run_commands, _run_commands_new
...
def _prepare_protein(protein_path) -> Path:
    ...
    commands = [
        ...
        f"cd {protein_folder}",
        f"/home/ubuntu/anaconda3/envs/mgltools/bin/python /home/ubuntu/anaconda3/envs/mgltools/bin/prepare_receptor4.py -r {protein_name} -o {protein_pdbqt.name}",
    ]
    _run_commands_new(commands)
...
def _prepare_ligand(ligand_path) -> Path:
    ...
    commands = [
        ...
        "conda activate mgltools",
        f"cd {ligand_folder}",
        f"/home/ubuntu/anaconda3/envs/mgltools/bin/python /home/ubuntu/anaconda3/envs/mgltools/bin/prepare_ligand4.py -l {ligand_name} -o {ligand_pdbqt.name}",
    ]
    _run_commands_new(commands)
    return ligand_pdbqt
